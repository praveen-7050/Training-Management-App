  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/events/:eventId/nominees" element={<PrivateRoute><NomineeList /></PrivateRoute>} />
        <Route path="/events/:eventId/nominees/add" element={<PrivateRoute><NomineeForm /></PrivateRoute>} />
